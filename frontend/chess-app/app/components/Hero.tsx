export default function Hero() {
    return (
        <section className="relative w-full min-h-[80vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-[#1a1c20] to-[#0f1012] -z-10" />
            ...
            <div className="max-w-4xl mx-auto z-10 flex flex-col items-center gap-6">
                ...
                <ul className="text-left text-gray-300 space-y-3 mt-4 text-sm md:text-base bg-white/5 p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 mt-4">
                    ...
                    <a
                        href="/tournament"
                        className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-bold rounded-lg border border-white/10 backdrop-blur-sm transition-all"
                    >
                        Join Tournament
                    </a>
                </div>
